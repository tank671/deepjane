...
model_file_url = 'https://onedrive.live.com/download?cid=9DE19E4EE91F5C09&resid=9DE19E4EE91F5C09%21105&authkey=APcyqCLeEBTWIVU'
model_file_name = 'austen_fine'
...
async def setup_learner():
    ...
    austen_lm = TextLMDataBunch.load(path/'static', 'austen_lm')
    data_bunch = (TextList.from_csv(path, csv_name='static/blank.csv', vocab=austen_lm.vocab)
        .random_split_by_pct()
        .label_for_lm()
        .databunch(bs=10))
